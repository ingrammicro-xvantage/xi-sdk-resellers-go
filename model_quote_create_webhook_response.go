...
// checks if the QuoteCreateWebhookResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuoteCreateWebhookResponse{}

// QuoteCreateWebhookResponse struct for QuoteCreateWebhookResponse
type QuoteCreateWebhookResponse struct {
	...
	Resource *QuoteCreateWebhookResponseResource `json:"resource,omitempty"`
}
...
func NewQuoteCreateWebhookResponse() *QuoteCreateWebhookResponse {
	this := QuoteCreateWebhookResponse{}
	return &this
}
...
func (o *QuoteCreateWebhookResponse) GetResource() QuoteCreateWebhookResponseResource {
	if o == nil || IsNil(o.Resource) {
		var ret QuoteCreateWebhookResponseResource
		return ret
	}
	return *o.Resource
}
...
// SetResource gets a reference to the given QuoteCreateWebhookResponseResource and assigns it to the Resource field.
func (o *QuoteCreateWebhookResponse) SetResource(v QuoteCreateWebhookResponseResource) {
	o.Resource = &v
}

func (o QuoteCreateWebhookResponse) MarshalJSON() ([]byte, error) {
...
func (o QuoteCreateWebhookResponse) ToMap() (map[string]interface{}, error) {
...
type NullableQuoteCreateWebhookResponse struct {
	value *QuoteCreateWebhookResponse
	isSet bool
}

func (v NullableQuoteCreateWebhookResponse) Get() *QuoteCreateWebhookResponse {
	return v.value
}

func (v *NullableQuoteCreateWebhookResponse) Set(val *QuoteCreateWebhookResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuoteCreateWebhookResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuoteCreateWebhookResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuoteCreateWebhookResponse(val *QuoteCreateWebhookResponse) *NullableQuoteCreateWebhookResponse {
	return &NullableQuoteCreateWebhookResponse{value: val, isSet: true}
}

func (v NullableQuoteCreateWebhookResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuoteCreateWebhookResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
